...
{
    public function __construct(private readonly TranslatorInterface $translator, private readonly SettingsTool $settingsTool)
    {
    }
    ...
    public function checkBreakTime(array $timesheets)
    {
        ...
        $timesheets = array_filter(
            $timesheets,
            fn (Timesheet $timesheet) => $timesheet->getProject()->getCustomer()->getId() != $customerId
        );
